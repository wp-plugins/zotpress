...
= Features =
* Displays your individual and group Zotero items through in-text citations, bibliographies, and searchable libraries
...
1. Import your Zotero library.
1. In the Browse page, look up the keys of the items, collections or tags you wish to display. Or, use the Zotpress Reference Widget to generate shortcodes.
1. Place the shortcodes in your blog entry or page, or enable the Zotpress sidebar widget.
