<?php
    ...
    if (isset($_GET['account_id']) && preg_match("/^[0-9]+$/", $_GET['account_id'])) {
        ...
        if (get_option("Zotpress_DefaultAccount")) {
            $temp = $wpdb->get_row("SELECT id, nickname FROM ".$wpdb->prefix."zotpress WHERE api_user_id='".get_option("Zotpress_DefaultAccount")."'", OBJECT);
            $account_id = $temp->id;
            $account_name = $temp->nickname;
        }
        else
        {
            $temp = $wpdb->get_results("SELECT id, nickname FROM ".$wpdb->prefix."zotpress LIMIT 1");
        ...
        <div id="zp-Browse">
            ...
            <div id="zp-Filter">
                <div id="zp-FilterInner">
                    ...
                    <div id="zp-FilterByTag-Section" class="section last">
            ...
            <div id="zp-List"><?php
                ...
                if ($collection_id)
                {
                    ...
                    echo "<h3><em>".$zp_collection[0]->title."</em> (".$collection_id.")";
                ...
                if ($tag_name) {
                    echo "<h3>Viewing Items Tagged \"<em>".$tag_name."</em>\"";
