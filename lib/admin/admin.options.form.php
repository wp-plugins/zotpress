            ...
            <div class="zp-Column-2">
                ...
                <p class="note">Note: Styles must be listed <a title="Zotero Styles" href="http://www.zotero.org/styles">here</a>; not all styles have been tested.</p>
                ...
                <div id="zp-Zotpress-Options-Style-Container" class="zp-Zotpress-Options">
                    ...
                    jQuery(document).ready(function() {
                        ...
                        jQuery("#zp-Zotpress-Options-Style option#new").click(function()
                        {
                            jQuery("#zp-Zotpress-Options-Style-New-Container").show();
                        });
                        
                        jQuery("#zp-Zotpress-Options-Style option:not('#new')").click(function()
                        {
                        ...
                        jQuery("#zp-Zotpress-Options-Style-Button").click(function()
                        {
                            ...
                            jQuery.get(xmlUri, {}, function(xml)
                            {
                                ...
                                {
                                    jQuery('#zp-Zotpress-Options-Style-Container div.zp-Errors').html("<p>"+jQuery('errors', xml).text()+"</p>\n");
