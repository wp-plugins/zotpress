<?php
    ...
    function Zotpress_zotpressInTextBib ($atts)
    {
        ...
        */
        ...
        if ( $sortby != "default" && isset($GLOBALS['zp_shortcode_instances'][get_the_ID()]) )
        ...
        if ( ( strtolower($title) == "yes" || strtolower($title) == "true" )  && isset($GLOBALS['zp_shortcode_instances'][get_the_ID()]) )
        ...
        if ( isset($GLOBALS['zp_shortcode_instances'][get_the_ID()]) )
        {
            foreach ($GLOBALS['zp_shortcode_instances'][get_the_ID()] as $item => $zp_citation)
            {
                ...
                // OUTPUT
                $zp_output .= "<a title='Reference to citation for `".$zp_citation["title"]."`' id='zp-".get_the_ID()."-".$zp_citation["item_key"]."'></a><div class='zp-ID-".$zp_citation['userid']."-".$zp_citation["item_key"]." zp-Entry".$has_citation_image."'>\n";
